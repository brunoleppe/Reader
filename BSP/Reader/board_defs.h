...
#define LCD_SPI_DRIVER_INDEX            1
#define FLASH_SPI_DRIVER_INDEX          2

#define QT_SPI_DRIVER_INDEX_CLIENTS             SPI_DRIVER_INSTANCE_0_CLIENTS
#define LCD_SPI_DRIVER_INDEX_CLIENTS            SPI_DRIVER_INSTANCE_1_CLIENTS
#define FLASH_SPI_DRIVER_INDEX_CLIENTS          SPI_DRIVER_INSTANCE_2_CLIENTS
